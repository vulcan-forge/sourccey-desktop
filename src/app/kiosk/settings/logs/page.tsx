...
export default function KioskSettingsLogsPage() {
    ...
    const loadAllLogs = async () => {
        if (!isTauri()) {
            setAllLogError('Logs are only available in the kiosk app.');
            return;
        }
        ...
        <div className="min-h-screen bg-slate-900/30">
            <div className="container mx-auto flex flex-col gap-8 px-8 py-8">
                <div className="">
                    ...
                    <p className="mt-2 text-sm text-slate-300">Review local log files captured on the robot.</p>
                    <div className="mt-4">
                        <Link
                            href="/kiosk/settings"
