...
export default function WelcomePage() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 transition-opacity duration-1500"
    ...
    >
      <div className="relative flex flex-col items-center justify-center overflow-hidden rounded-2xl border-2 border-slate-700/50 bg-slate-800/80 p-8 backdrop-blur-md shadow-2xl">
        ...
        <p className="text-md mb-8 text-center font-semibold text-slate-300">
