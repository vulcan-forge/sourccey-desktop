                ...
                <div className="flex h-full w-full items-center">
                    ...
                    <div className="ml-auto flex items-center gap-4">
                        ...
                        <button
                            ...
                            className={`flex h-11 cursor-pointer items-center justify-center gap-2 rounded-xl border px-3.5 text-sm font-semibold transition-all duration-300 hover:border-slate-400/60 hover:bg-slate-600/80 hover:text-white ${
                                isSystemInfoLoading
                                    ? 'border-slate-500/50 bg-slate-600/60 text-white'
                                    : getBatteryStatusSurfaceClasses(batteryPercent)
                            }`}
                        ...
                        <button
                            ...
                            className="flex h-11 cursor-pointer items-center justify-center gap-2.5 rounded-xl border border-slate-500/50 bg-slate-700/60 px-3 text-left text-sm font-semibold text-slate-200 transition-all duration-300 hover:border-blue-400/40 hover:bg-slate-600/80 hover:text-white"
                            title="WiFi Settings"
                        >
