...
pub struct RemoteInferenceProcess2(Arc<Mutex<HashMap<String, (CommandChild, Arc<AtomicBool>, String)>>>);

pub struct RemoteInferenceService2;

impl RemoteInferenceService2 {
    pub fn init_remote_inference() -> RemoteInferenceProcess2 {
        RemoteInferenceProcess2(Arc::new(Mutex::new(HashMap::new())))
    }

    pub async fn start_inference(
        app_handle: AppHandle,
        db_connection: DatabaseConnection,
        state: &RemoteInferenceProcess2,
